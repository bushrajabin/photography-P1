...
const dummy_Data = [
  ...
  },
  {
    ...
    Description:
      "A leaf  is a principal appendage of the stem of a vascular plant,[1] usually borne laterally aboveground and specialized for photosynthesis. Leaves are collectively called foliage,",
  },
  {
    id: 15,
    type: "eveningVibe",
...

  {
    ...
    Description:
      "A camera is an optical instrument used to capture and store images or videos, either digitally via an electronic image sensor,",
  },
  {
    id: 18,
    type: "BBg",
  ...
  },
  {
    ...
    Description:
      "Portulaca grandiflora is a succulent flowering plant in the purslane family Portulacaceae, native to southern Brazil, Argentina, and Uruguay and often cultivated in gardens. It has many common names, including rose moss, eleven o'clock, Mexican rose, moss rose, sun rose, rock rose, and moss-rose purslane.",
  },
  {
    id: 26,
    type: "Moss-rose purslane",
  ...
  },
  {
    ...
    Description:
      "Blue Sky Quotes are optimistic, visionary statements about the future. They can be used to galvanize people around a common goal or simply to make them feel good.",
  },
  {
    id: 28,
    type: "Leaf",
  ...
  },
  {
    ...
    Description:
      "Bougainvillea are popular ornamental plants in India and most areas with warm climates and grown both as shrub and vine. Genus Bougainvillea are vine-like evergreen shrubs, sometimes thorny, with simple ovate leaves and clusters of small tubular flowers that grows rampantly",
  },
  {
    id: 30,
    ...
    Description:
      "It is basically a circular hanging restaurant positioned on four arc-shaped steel pillars. The hanging restaurants in Malaysia and Visitor's Gallery in Eiffel Tower in Paris have inspired the government authorities of Kolkata to come up with this iconic structure.",
  },
  {
    id: 31,
    type: "Canna glauca",
  ...
  },
  {
    ...
    Description:
      "Lantana camara is a species of flowering plant within the verbena family, native to the American tropics. It is a very adaptable species, which can inhabit a wide variety of ecosystems; once it has been introduced into a habitat it spreads rapidly; ",
  },
  {
    id: 35,
    type: "Tajmahal",
  ...
  },
  {
    ...
    Description:
      "Ixora is a genus of flowering plants in the family Rubiaceae.[1] It is the only genus in the tribe Ixoreae. It consists of tropical evergreen trees and shrubs and holds around 544 species",
  },
  ...
  },
  {
    ...
    Description:
      "The Sun is the largest object in our solar system. The Sun’s volume would need 1.3 million Earths to fill it. Its gravity holds the solar system together, keeping everything from the biggest planets to the smallest bits of debris in orbit around it. The hottest part of the Sun is its core,",
  },
  {
    id: 40,
    type: "butterfly",
...
// THIS FUNCTION FOR SHOW IMAGES fu

function forDummyImage() {
